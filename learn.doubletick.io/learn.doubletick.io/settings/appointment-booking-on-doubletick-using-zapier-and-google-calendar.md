# Appointment Booking on DoubleTick Using Zapier and Google Calendar
...
1. **Enable Appointment Booking**:
   ...
   * Select **Appointment Schedule** and configure the time slots available for bookings.
     ...
     ![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2FBDIYpUzKoFBQZoXP5B1M%2F0.png?alt=media)
...
![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2FyLJGQZAFmdeUPsojm1JC%2F1.png?alt=media)
...
2. **Configure Trigger Settings**:
   ...
   * Test the trigger to ensure Zapier detects new appointments correctly.
     ...
     ![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2Fk5L3xfcA8h0jiRcZuHYn%2F2.png?alt=media)
...
2. **Extract the Contact Number**:
   ...
   * Use text parsing or split text functions to isolate the phone number.
     ...
     ![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2Flm4HqU4wSulwCYEJvjae%2F3.png?alt=media)
...
![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2FOcsFNraQda7yhpa6j6OZ%2F4.png?alt=media)
...
2. **Customize the Message**:
   ...
   * Use personalized templates to include specific details such as:
     * “Hi \[Client Name], your appointment is confirmed for \[Date & Time].”
       ...
       ![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2FGVX5Eg5rwyqztk60uAX7%2F5.png?alt=media)
3. **Test the Zap**:
   * Test the workflow to ensure the confirmation message is sent correctly upon booking.

     ![](https://2303112206-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F53n17VnOICC1LtDqlENV%2Fuploads%2FSiPAQFGFGg1862xev1FI%2F6.png?alt=media)
